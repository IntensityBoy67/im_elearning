   ...
   <div class="site-wrapper">
                              ...
                              <div class="row">
							   ...
							   ?>
                                <div class="col-lg-12" style = "width: 1200px; border-bottom: 2px;">
                                      ...
                                      <div style="float: left; width: 800px; height:400px;" class="col-lg-8">
									  
											<img style = "height: 350px;  width: 700px;"  class="img-responsive" src="<?php echo base_url().'course_imgs/'.$this->input->get('id').$course_info['course_image']; ?>" alt= "No Preview Available">

                                      </div>
 
                                      <div style="margin-left:3px;border-bottom: 1px solid #ccc; float: left; " class="jumbotron col-sm-3">

                                        
                                      <p style="font-size:15px;"><label><strong>Lectures:</strong> 
                                          <?php
									    ...
									    <p style="font-size:15px;">
											 <label style="font-size:15px;"><strong>Rank: </strong></label>
 											 ...
 											 <p style="font-size:15px;"><strong>Enrollees: </strong></label>
                                        ...
                                        <p style="font-size:15px;"> <label><strong>Languages:</strong> English</label></p><br>
	...
	<div style ="clear: both;"></div>
                                            ...
                                            <div class="table-responsive">
                                                    ...
                                                    <tr>
                                                    <th>Teacher</th>
                                                    <th><?php echo ($instrct['Fname']). ' '. ($instrct['Lname']); ?></th>
                                                    </tr>  

                                                    <tr>
                                                    <td>Vacancies:</td>
                                                    <td><?php echo ($instrct['Vacant_Sched']); ?> 
                                                    </tr>  

                                                     <tr>
                                                    <td>Email:&nbsp;</td>
                                                    <td><?php echo ($instrct['Email']); ?></td>
                                                    </tr> 
                                                     </table>
