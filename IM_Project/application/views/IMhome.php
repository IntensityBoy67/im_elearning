...
<html>
					...
					<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	  					<div class="container-fluid">
	    					<div class="navbar-header">
					      		...
					      		<a class="navbar-brand" href="#"><img src="img/logo trans small.png" class="img-responsive" alt="brand"></a>
					    	</div>
			...
			<div class="container">
				...
				<div class="row main_content">
					<div class="col-md-4 wow animated zoomIn" data-wow-delay="0.1s">
						<figure>
							<img class="pro img-responsive center-block thumbnail" src="img/Kongsberg-Maritime-kunde-av-Communicate-på-Microsoft-BizTalk-Server.jpg">
						</figure>
						...
						<div class="row">
							<div class="col-xs-12 text-center" style="border-right: 1px solid #f4f4f4">
                                <div style="display: inline; width: 60px; height: 60px;">
                                    <input type="text" class="knob" data-readonly="true" value="90" data-width="60" data-height="60" data-fgcolor="#2082d9" readonly="readonly" style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px; font-weight: bold; font-style: normal; font-variant: normal; font-stretch: normal; font-size: 12px; line-height: normal; font-family: Arial; text-align: center; /* color: 2f7cbe; */ padding: 0px; -webkit-appearance: none; background: none;">
                                </div>
                            </div>	<!-- col-xs-12 -->
						</div>	<!-- row -->
					</div>	<!-- col-md-4 -->
					...
					<div class="col-md-4 wow animated zoomIn" data-wow-delay="0.1s">
						<figure>
							<img class="pro img-responsive center-block thumbnail" src="img/Kongsberg-Maritime-Presents-Modular-Subsea-Monitoring-Network-MSM.jpg">
						</figure>
						<h5 class="text-center">Android Development</h5>
						<div class="row">
							<div class="col-xs-12 text-center" style="border-right: 1px solid #f4f4f4">
	                            <div style="display: inline; width: 60px; height: 60px;">  	
	                            	<input type="text" class="knob" data-readonly="true" value="80" data-width="60" data-height="60" data-fgcolor="#2082d9" readonly="readonly" style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px; font-weight: bold; font-style: normal; font-variant: normal; font-stretch: normal; font-size: 12px; line-height: normal; font-family: Arial; text-align: center; /* color: 2f7cbe; */ padding: 0px; -webkit-appearance: none; background: none;">
	                            </div>
	                        </div>	<!-- col-xs-12 -->
						</div>	<!-- row -->
					</div>	<!-- col-md-4 -->
					...
					<div class="col-md-4 wow animated zoomIn" data-wow-delay="0.1s">
						<figure>
							<img class="pro img-responsive center-block thumbnail" src="img/Kongsberg-to-Supply-Simulators-for-Headway-Seacrest-Maritime-Foundation-The-Philippines.jpg">
						</figure>
						<h5 class="text-center">iOS Development</h5>
						<div class="row">
							<div class="col-xs-12 text-center" style="border-right: 1px solid #f4f4f4">
	                            <div style="display: inline; width: 60px; height: 60px;">
	                                <input type="text" class="knob" data-readonly="true" value="75" data-width="60" data-height="60" data-fgcolor="#2082d9" readonly="readonly" style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px; font-weight: bold; font-style: normal; font-variant: normal; font-stretch: normal; font-size: 12px; line-height: normal; font-family: Arial; text-align: center; /* color: 2f7cbe; */ padding: 0px; -webkit-appearance: none; background: none;">
	                        	</div>	
	                    	</div>	<!-- col-xs-12 -->
						</div>	<!-- row -->
					</div>	<!-- col-md-4 -->
			    	...
			    	<div class="row main_content">
				    	<div class="col-md-6 col-sm-6 text-center">
				    		<div class="row wow animated zoomIn" data-wow-delay="0.1s">
				    			<div class="col-md-8 col-md-offset-2">
				    				<img class="img-circle img-responsive center-block" src="img/11287_837289506281578_4406149510896296035_n.jpg" alt="Syed Rezwanul Haque Rubel">
				    			</div>
				    		</div>
				    	...
				    	<div class="col-md-6 col-sm-6 text-center">
				    		<div class="row wow animated zoomIn" data-wow-delay="0.1s">
				    			<div class="col-md-8 col-md-offset-2">
				    				<img class="img-circle img-responsive center-block" src="img/10983499_938902346120293_3609508748133937774_o.jpg" alt="Syed Rezwanul Haque Rubel">
				    			</div>
				    		</div>
				        	<h4 class="wow animated fadeInUp" data-wow-delay= "0.2s">Syed Rezwanul Haque Rubel</h4>
				        	<p class= "member-title wow animated fadeIn" data-wow-delay= "0.3s">Project Manager</p>
				    	...
				    	<div class="col-md-6 col-sm-6 text-center">
				    		<div class= "row wow animated zoomIn" data-wow-delay="0.6s">
				    			<div class= "col-md-8 col-md-offset-2">
				    				<img class="img-circle img-responsive center-block" src="img/1263032_663650933653300_574779661_o.jpg" alt= "Shahjahan Jewel" >
				    			</div>
				    		</div>
				    	...
				    	<div class="col-md-6 col-sm-6 text-center">
				    		<div class= "row wow animated zoomIn" data-wow-delay="1.1s">
				    			<div class="col-md-8 col-md-offset-2">
				    				<img class="img-circle img-responsive center-block" src="img/10419600_690802087640425_1564481368035332097_n.jpg" alt= "Nathan Thomas Paul" >
				    			</div>
				    		</div>
	    		...
	    		<div class="main_content">
		    		...
		    		<div class="row">
		    			<div class="isotope" id="port-items">
		    				...
		    				<div class="thumbnail">
		    					<img class="img-responsive" src="img/KM_PEM_Contract_OVS_General.jpg">
		    				</div>
		    				</div>
		    				...
		    				<div class="col-md-4 col-sm-6 col-xs-6 element-item game" data-category="game">
		    				<div class="thumbnail">
		    					<img class="img-responsive" src="img/Kongsberg Maritime.jpg">
		    					</div>
		    				</div>
		    				<div class="col-md-4 col-sm-6 col-xs-6 element-item app" data-category="app">
		    				<div class="thumbnail">
		    				...
		    				<div class="col-md-4 col-sm-6 col-xs-6 element-item game" data-category="game">
		    				<div class="thumbnail">
		    					<img class="img-responsive" src="img/bsm_045_1.jpg">
		    					</div>
		    				</div>
		    				<div class="col-md-4 col-sm-6 col-xs-6 element-item app" data-category="app">
		    				<div class="thumbnail">
  ...
  <div class="container">
  <div class="col-md-4">
    <div class="jumbotron"  id="leftCol"  style="background-color:#e8f3e8;">
    <div class="form-group has-primary">
        <h3 class="form-signin-heading">Log In</h3>
<?php echo form_open('IM/validateLogin'); ?>
...
<?php echo form_close(); ?>
<br>
<a href="<?php echo site_url('IM/UserEmailcheck') ?>">Forgot your password?</a>
      </div>
    </div> <!-- /container -->
  </div>
                                      ...
                                      <div class="col-lg-12">
										  ...
										  <?php 
												...
												if(isset($username) && $username == 1) 
													echo "<p class ='text text-danger'>Username Already Exists!<p>";
												if(isset($email) && $email == 1) 
													echo "<p class ='text text-danger'>Email Already Exists!<p>";
												if(isset($pass) && $pass == 1) 
													echo "<p class ='text text-danger'>Password Does not Match!<p>";
												
												
												
												?>
                                          <br>
                             <?php echo form_open('IM/InputaddUser', array('id' => 'form_reg'));?>
...
$("input[name='username']").change(function(){
              ...
              $.post("index.php/Admin/uservalidate", {username: $("input[name='username']").val()}, 
                ...
                function(data){
                    ...
                    if(data >= 1){
                      $("#username_flag").html("<span class= 'text text-info'> Username Already Existed!</span>");
                      flag2 = 1; 
                  }

                   else $("#username_flag").html("");
                        ...
                        $("input[name='Email']").change(function(){
				 			...
				 			$.post("index.php/IM/emailvalidate", {email: $("input[name='Email']").val()}, 
				 				...
				 				function(data){
				 						...
				 						if(data >= 1){
					 						$("#email_flag").html("<span class= 'text text-danger'>Email Already Existed!</span>");
				 							flag = 1;	
				 					}
