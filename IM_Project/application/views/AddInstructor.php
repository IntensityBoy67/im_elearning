    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
       ...
       <div class="col-md-12" style="background-color: #222;">
          ...
          <h1><span class="glyphicon glyphicon-user"></span> New Instructor</h1>  
		  
          </div>
                  <p ><font color = "red">* </font>(Indicates required field)</p>
				  <br>
 <?php echo form_open('Admin/addInstructor');?>
                              ...
                              <div class='form-group col-lg-12 has-info'>
                              <label>Vacant Schedule(s) </label>
							  
                              <textarea class='form-control'  name = "Vacant_Sched"></textarea>
                              ...
                              <div class='form-group col-lg-12 has-info'>
                              <label><font color = "red"></font> Local Phone Number </label>
                              <input type='text' class='form-control' placeholder='Phone Number' maxlength= 9 name="Phonenumber"  />
                              </div>
							  
							  
							<div class='form-group col-lg-12 has-info'>
                              <label><font color = "red">* </font> Mobile Number  </label>
                              <input type='text' class='form-control' placeholder='Mobile number' maxlength= 11 name="mobile_number"  required/>
                              </div>
