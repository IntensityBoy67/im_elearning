	  ...
	  <div id="login-page">
	  	<div class="container">
		     ...
		     <?php echo form_open('Admin/checkID'); ?>
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" href="index.html" type="submit"><i class="glyphicon glyphicon-send"></i>    Send ID number</button>
