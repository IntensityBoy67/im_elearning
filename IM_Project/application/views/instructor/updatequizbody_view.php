...
<div class="container">
    <div class="row well">
        ...
        <div class="col-md-12" id="question" >
            <?php
            if ($quiz_update) {
                echo form_open("instructor/quizmodify/" . $this->uri->segment(3), array('id' => 'quiz_form'));
            } else {
                echo form_open("instructor/addquiz", array('id' => 'quiz_form'));
            }
            ?>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">	
                        ...
                        <select class="form-control"  name="course_id" id="course_id">
                            ...
                            foreach ($courses as $course) {
                                ?>
                                <option <?php
                                if ($quiz_update->courseID == $course->courseID) {
                                    echo 'selected';
                                }
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?= $quiz_update->quiz_name ?>"  class="form-control" name="assement_name" id="assement_name"  required/><br>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="time" name="time_limit" value="<?= $quiz_update->quiz_timelimit ?>" id="time_limit" class="form-control" placeholder="00.00.00" required/>
                    </div>
                    <div class="col-md-6">
                        <label>Points for Questions</label><span class="required">*</span>
                        <select class="form-control" name="points" id="points">
                            <option <?php
                            if ($quiz_update->points == 10) {
                                echo 'selected';
                            }
                            ?> >10 points</option>
                            <option <?php
                            if ($quiz_update->points == 20) {
                                echo 'selected';
                            }
                            ?> >20 points</option>
                            <option <?php
                            if ($quiz_update->points == 30) {
                                echo 'selected';
                            }
                            ?> >30 points </option>
                            <option <?php
                            if ($quiz_update->points == 40) {
                                echo 'selected';
                            }
                            ?> >40 points</option>
                            <option <?php
                            if ($quiz_update->points == 50) {
                                echo 'selected';
                            }
                            ?> >50 points</option>
                        </select>
                ...
                <input class="form-control"  type="text" id="question" name="question" value="<?= $quiz_update->quiz_question ?>"
                       title="Please enter question" required /><br>
                <label>Option 1</label><span class="required">*</span>
                <input class="form-control" type="text" name="answer1" id="answer1" value="<?= $quiz_update->quiz_ans1 ?>" required/><br>
                <label>Option 2</label><span class="required">*</span>
                <input class="form-control" type="text" name="answer2" id="answer2" value="<?= $quiz_update->quiz_ans2 ?>" required/><br>
                <label>Option 3</label><span class="required">*</span>
                <input class="form-control" type="text" name="answer3" id="answer3" value="<?= $quiz_update->quiz_ans3 ?>" required/><br>
                <label>Option 4</label><span class="required">*</span>
                <input class="form-control" type="text" name="answer4" id="answer4" value="<?= $quiz_update->quiz_ans4 ?>" required/><br>
                <label>Option 5</label><span class="required">(Optional)</span>	
                <input class="form-control" type="text" name="answer5" id="answer5" value="<?= $quiz_update->quiz_ans5 ?>" /><br>		
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select  name="canswer1" id="canswer1" class="form-control"
                                ...
                                <option <?php
                                if ($quiz_update->correct_ans1 == 1) {
                                    echo 'selected';
                                }
                                ?> value="1">Option 1</option>
                                <option <?php
                                if ($quiz_update->correct_ans1 == 2) {
                                    echo 'selected';
                                }
                                ?> value="2">Option 2</option>
                                <option <?php
                                if ($quiz_update->correct_ans1 == 3) {
                                    echo 'selected';
                                }
                                ?> value="3">Option 3</option>
                                <option <?php
                                if ($quiz_update->correct_ans1 == 4) {
                                    echo 'selected';
                                }
                                ?> value="4">Option 4</option>
                                <option <?php
                                if ($quiz_update->correct_ans1 == 5) {
                                    echo 'selected';
                                }
                        ...
                        <div class="col-md-4">
                            ...
                            <select  name="canswer2" id="canswer2" class="form-control"
                                ...
                                <option value="">Select one</option>
                                <option <?php
                                if ($quiz_update->correct_ans2 == 1) {
                                    echo 'selected';
                                }
                                ?> value="1">Option 1</option>
                                <option <?php
                                if ($quiz_update->correct_ans2 == 2) {
                                    echo 'selected';
                                }
                                ?> value="2">Option 2</option>
                                <option <?php
                                if ($quiz_update->correct_ans2 == 3) {
                                    echo 'selected';
                                }
                                ?> value="3">Option 3</option>
                                <option <?php
                                if ($quiz_update->correct_ans2 == 4) {
                                    echo 'selected';
                                }
                                ?> value="4">Option 4</option>
                                <option <?php
                                if ($quiz_update->correct_ans2 == 5) {
                                    echo 'selected';
                                }
                                ?> value="5">Option 5</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select  name="canswer3" id="canswer3" class="form-control"
                                ...
                                <option value="">Select one</option>
                                <option <?php
                                if ($quiz_update->correct_ans3 == 1) {
                                    echo 'selected';
                                }
                                ?> value="1">Option 1</option>
                                <option <?php
                                if ($quiz_update->correct_ans3 == 2) {
                                    echo 'selected';
                                }
                                ?> value="2">Option 2</option>
                                <option <?php
                                if ($quiz_update->correct_ans3 == 3) {
                                    echo 'selected';
                                }
                                ?> value="3">Option 3</option>
                                <option <?php
                                if ($quiz_update->correct_ans3 == 4) {
                                    echo 'selected';
                                }
                                ?> value="4">Option 4</option>
                                <option <?php
                                if ($quiz_update->correct_ans3 == 5) {
                                    echo 'selected';
                                }
                                ?> value="5">Option 5</option>
                            </select>
