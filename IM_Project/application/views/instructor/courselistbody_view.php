...
<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            ...
            <table id="answers" cellpadding='0' cellspacing='0' border='0' style='width:100%;' class='datatable1 table table-striped table-bordered'>
                ...
                <tbody>
                    ...
                    foreach ($courses as $course){
                        ...
                        <tr>
                            <td>
								<img alt = "No Preview Available" src="<?= base_url('course_imgs'). '/'.$course['courseID'].$course['course_image']; ?>" style="width:200px;">                            </td>
                            <td>
                                <?php

                                //$course_info = $p->getCourseInfo($course->course_id);

                                echo "<a href= 'presentation?id=".$course['courseID']."'>" . $course['CourseName']. "</a>";
							...
							<td>
								...
								$lecs_no =$p->count_lecs($course['courseID']);
								if($lecs_no != 0){
								echo "No. of Lectures: ".$lecs_no;
                                    ?>
									<br><a href= "<?php echo 'ListLectures?course_id='.$course['courseID']; ?>">View Lecture</a>
									<?php 
                                }else{ 
								?>
									No Lectures uploaded yet!
									<br><a href= "<?php echo 'addlectures?course_id='.$course['courseID']; ?>">Upload Lecture</a>
 ...
 <td>
			...
			$php_date= strtotime($course['date_expired']);
			...
			echo date("M d, Y", $php_date);
						...
						<td>
									...
									$php_date=  date("M d, Y", $php_date);
									  ...
									  if(empty($row)) echo "<span class= 'text text-danger'>No Activities Yet!</span>";
									  
									  echo "<span class= 'text text-info'>".$row['notif_desc']."</span><br><br>";
									  
									  echo "<span class= 'text text-danger'>".$php_date."</span><br>";
