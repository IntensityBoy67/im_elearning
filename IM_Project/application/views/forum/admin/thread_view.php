<div class="span10">  
    ...
    $(function() {
        ...
        $('#btn-delete').click(function() {
            window.location = '<?php echo site_url('forumAdmin/thread_delete'); ?>/'+thread_id;
        });
    })
    </script>
    ...
    <tbody>
        ...
        <td style="text-align: center;"><a title="edit" href="<?php echo site_url('forumAdmin/thread_edit').'/'.$thread->id; ?>"><img src="<?php echo base_url(); ?>resources/icons/pencil.png"/></a> </td>
        <td style="text-align: center;"><a title="delete" class="del" id="thread_id<?php echo $thread->id; ?>" href="<?php echo site_url('forumAdmin/thread_delete').'/'.$thread->id; ?>"><img src="<?php echo base_url(); ?>resources/icons/delete.png"/></a> </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
