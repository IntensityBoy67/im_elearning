<div class="span10">  
    ...
    $(function() {
        ...
        $('#btn-delete').click(function() {
            window.location = '<?php echo site_url('forumAdmin/role_delete'); ?>/'+role_id;
        });
    })
    </script>
    ...
    <div class="span8">
        ...
        <tbody>
             <tr>
                <?php foreach ($roles as $role): ?>
                <td>
                    <a title="edit" href="<?php echo site_url('forumAdmin/role_edit').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>resources/icons/pencil.png"/></a> 
                    &nbsp;&nbsp;
                    <a title="delete" class="del" id="role_id_<?php echo $role['id']; ?>" href="<?php echo site_url('forumAdmin/role_delete').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>resources/icons/delete.png"/></a> 
                </td>
                <?php endforeach; ?>
            </tr>
			<tr>
