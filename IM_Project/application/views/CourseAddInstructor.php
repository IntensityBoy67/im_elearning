...
<?php echo form_open('Admin/addIntinCourse');?>
     ...
     <div class='form-group has-primary'>
       <label>Course to be assigned</label>
     <?php //* print_r($course); ?>
  ...
  <?php }?>              
     ...
     <div class='form-group has-primary'>
       <label>Teacher to be assigned</label>
         <select class='form-control' name="IdNum">
  ...
  <?php }}?>  
     ...
     <div class='form-group has-primary'>
         <label>Date assigned </label>
           <input type="datetime-local" class='form-control' name="date_instruct" required  />
     </div>
...
<div class="row">
<div class="col-md-12"><h3 style="color:#111;">Assigned instructor</h3></div>
