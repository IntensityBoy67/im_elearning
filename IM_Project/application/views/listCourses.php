...
<div class="col-lg-12" style="background-color: #fff; border-radius: 4px;">         
  <div class="table-responsive">
	...
	<option value = "arch">Inactived  Courses</option>
  ...
  $course_info = $courses->result();
   ...
   ?>
                 <tr <?php if(isset($course_id) && $course_id == $datas->courseID){ ?>
				 ...
				 <td ><?php 
					...
					$inst_info= $teach_model->getInstructorInfo($datas->IdNum);
				
				 echo ($datas->IdNum==NULL)? "<span class= 'label label-danger'>Not Yet Assigned</span>" :  $inst_info['Fname']. ' '.$inst_info['Lname']; ?></td>				 
		...
		echo ($datas->Date_release==NULL) ? "<span class= 'label label-danger'>Not Yet Released!</span>": $php_date; ?></td>
			...
			$php_date= date("M d, Y", $php_date);
				...
				echo $php_date; ?>
				  ...
				  <a href= "<?php echo 'viewCourse?courseID='.$datas->courseID; ?>" >[View]</a>
				  <a href= "<?php echo 'viewStuds?course_id='.$datas->courseID; ?>" >[View Student Lists]</a>
                  <a href= "<?php echo 'Updateviewcourse?courseID='.$datas->courseID; ?>" >[Edit]</a>
  ...
  <?php }
   ...
   ?>              
	...
	if(empty($course_info)){
		...
		echo "<p class= 'text text-danger'>No Inactive Courses!</a>";
		...
		echo ($datas->Date_release==NULL) ? "<span class= 'label label-danger'>Not Yet Released!</span>": $php_date; ?></td>
			...
			$php_date= date("M d, Y", $php_date);
				...
				echo $php_date; ?>
				  ...
				  <td><a href= "<?php echo 'reactivate_form?courseID='.$datas->courseID; ?>" class="btn btn-info"><span class="glyphicon glyphicon-success-sign">Re- Open</span></button>
